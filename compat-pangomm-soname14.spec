...
Requires: compat-pangomm-soname14-data = %{version}-%{release}
...
%package data
Summary: data components for the compat-pangomm-soname14 package.
Group: Data

%description data
data components for the compat-pangomm-soname14 package.
...
%package doc
Summary: doc components for the compat-pangomm-soname14 package.
Group: Documentation

%description doc
doc components for the compat-pangomm-soname14 package.
...
cp %{_builddir}/pangomm-2.42.1/COPYING.tools %{buildroot}/usr/share/package-licenses/compat-pangomm-soname14/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
%make_install
